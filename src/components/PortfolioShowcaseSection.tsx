...
export default function PortfolioGrid() {
  ...
  const projectsByCategory: Record<string, ProjectItem[]> = {
    ...
    "Social Media Management": [
      ...
      { type: "image", src: "/images/portfolio-images/social/social 5.png" },
      { type: "image", src: "/images/portfolio-images/social/social 6.png" },
      { type: "image", src: "/images/portfolio-images/social/social 7.png" },
      { type: "image", src: "/images/portfolio-images/social/social 8.png" },
    ],
    "Mobile App": [
